...
const char* buildStatus() {
    snprintf(statusBuf, sizeof(statusBuf),
        "{\"t\":\"s\",\"j\":[%d,%d,%d,%d,%d,%d],\"m\":%u,\"l\":%d,\"p\":%d,\"c\":%d,\"i\":%d}",
